# CLAUDE.md — Quantum Gastro Security Scanner

## Was ist dieses Projekt?
Gastro-Klon des Quantum KI-Sicherheits-Scanners. Analysiert öffentlich sichtbare Signale von Restaurant-Websites auf KI-Angriffsvektoren. Teil des AI-Gastro-Hub Ökosystems.
...
## Farbschema
- Primary: #FF2D55 (Neon-Rot — Quantum Branding)
- Background: #0A0A0A
...
- JINA_API_KEY
- NOTION_TOKEN
- NOTION_QUANTUM_LEADS_DB_ID

## Routing
/ (Landing) → /scanning (Loading) → /results (Score + Gate)
Datenweitergabe: sessionStorage['quantum_scan_result']
