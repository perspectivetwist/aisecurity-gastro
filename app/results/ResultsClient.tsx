  ...
  return (
    <main className={`min-h-screen ${!isUnlocked ? 'pb-32' : ''}`}>
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <ShareButton score={result.quantumScore} resultUrl={typeof window !== 'undefined' ? window.location.href : ''} />
        ...
        <div className="text-center pt-8 pb-4 border-t border-white/10 mt-8">
          <a
            href="https://www.ki-gastronomie.com?utm_source=quantum&utm_medium=report&utm_campaign=hotmail"
            target="_blank"
