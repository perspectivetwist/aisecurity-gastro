  ...
  return (
    <div className="mt-8 p-4 border border-white/10 rounded-lg bg-white/5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a href="https://geo-gastro.vercel.app" target="_blank" rel="noopener noreferrer" className="text-xs px-3 py-1.5 rounded border border-white/10 hover:border-white/30 text-gray-300 hover:text-white transition-colors">
          ⭐ GEO-Scanner
        </a>
