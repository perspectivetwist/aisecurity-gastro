  ...
  return (
    <div className="mt-8 p-4 border border-white/10 rounded-lg bg-white/5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a href="https://www.ki-gastronomie.com/geo-scanner" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded border border-white/10 hover:border-white/30 text-gray-300 hover:text-white transition-colors">
          <Globe size={14} style={{ color: '#A8E6A3' }} /> GEO-Scanner
        </a>
