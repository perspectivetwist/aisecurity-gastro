...
const FAQS = [
  {
    q: 'Was macht Quantum — und ist das ein Angriff auf meine Website?',
    a: 'Quantum scannt nur was ohnehin öffentlich sichtbar ist — genau das, was auch ein Angreifer sehen würde, bevor er aktiv wird. Kein Hacking, kein Penetrationstest, keine Installation. Du gibst deine URL ein, Quantum liest deine öffentliche Website wie ein normaler Besucher — und zeigt dir was dabei sichtbar wird.',
    trust: true,
  },
  {
    q: 'Warum gibt es Quantum?',
    a: 'KMUs haben keine Vorstellung davon, wie viel Angriffsmaterial ihre eigene Website öffentlich preisgibt. Fotos, Namen, Rollen, Chatbots, Formulare — alles ist Rohmaterial für KI-gestützte Angriffe.\n\nDas Kernproblem in Zahlen:\n\n• 71% aller Ransomware-Angriffe treffen KMUs (FZI / Transferstelle Cybersicherheit, Lagebild 2025)\n• +89% KI-gestützte Angriffe gegenüber Vorjahr (CrowdStrike Global Threat Report 2026)\n• 29 Minuten: durchschnittliche Zeit bis ein Angreifer ein System übernimmt (CrowdStrike 2026)\n• 83% aller Phishing-Mails sind KI-generiert (KnowBe4 Phishing Trends Report 2025)\n• Deepfake-Vorfälle stiegen Q1 2025 um 19% gegenüber ganzem Jahr 2024 (Keepnet 2026)\n\nKein Tool macht diese Exposition in unter 60 Sekunden sichtbar — auf KMU-Niveau verständlich.',
  },
  {
    q: 'Ich bin ein kleines Unternehmen — bin ich wirklich ein Ziel?',
    a: 'Ja. KMUs sind heute das bevorzugte Ziel — nicht weil sie viel haben, sondern weil sie weniger schützen. Laut VikingCloud 2026 sind Cyberangriffe erstmals das größte Geschäftsrisiko für kleine Unternehmen. KI macht Angriffe billiger und präziser: Eine Phishing-Mail die früher Stunden dauerte, wird heute in Sekunden personalisiert — aus den Infos auf deiner Website.',
  },
  {
  ...
  },
  {
    ...
    a: 'Das ist der Punkt. Quantum ist für Inhaberinnen gebaut — nicht für IT-Abteilungen. Du siehst einen Score von 0–100 und fünf verständliche Kategorien: Wie viel verrät deine Website über deine Mitarbeiter? Wie viel Deepfake-Material ist öffentlich? Wo können Angreifer Formulare missbrauchen? Kein Fachjargon, keine Abkürzungen — nur konkrete Befunde in normaler Sprache.',
  },
  {
    q: 'Was kostet das — und was wollt ihr von mir?',
    a: 'Der Quantum Score und alle 5 Dimensionen sind vollständig kostenlos. Für den detaillierten Findings-Report gibst du nur deine Email-Adresse ein. Kein Abo, kein Verkaufsgespräch, keine versteckten Kosten. Wir wollen wissen ob Quantum für KMUs nützlich ist — das ist alles.',
  },
  {
    q: 'Was ist der Unterschied zu einem Antivirus oder einer Firewall?',
    a: 'Antivirus und Firewall schützen was bereits bei dir ist — deinen Computer, dein Netzwerk. Quantum zeigt was von außen sichtbar ist — bevor ein Angriff überhaupt beginnt. Es geht nicht darum was du intern hast, sondern was ein Angreifer über dich herausfinden kann ohne jemals bei dir einzubrechen: Mitarbeiterfotos für Deepfakes, Formulare für automatisierte Angriffe, Chatbots als Einstiegspunkt.',
  },
  {
  ...
  },
  {
    ...
    a: 'Der Score ist kein Bauchgefühl. Quantum prüft über 25 konkrete Signale auf deiner Website — aufgeteilt in 5 Kategorien mit fester Gewichtung:\n\n• Datenprofil (20%) — Namen, Rollen, Emails: Rohmaterial für Phishing\n• Identität / Deepfake-Risiko (25%) — Fotos, Videos: Kloning-Material\n• KI-Einfallstore (20%) — Chatbots, AI-Widgets: Angriffspunkte\n• Manipulationsfläche (20%) — Formulare, Inputs: Injection-Risiko\n• Agent-Zugang (15%) — robots.txt, llms.txt: Wie offen für KI-Bots?\n\nIdentität bekommt das höchste Gewicht weil Deepfake-Angriffe auf KMU-Inhaberinnen das am schnellsten wachsende Risiko 2026 sind. Score 100 = minimale Exposition. Kein Score bedeutet Perfektion — er zeigt wo du stehst.',
  },
  {
